      ...
      <div className="wraprtr-thos-foloeor">
        ...
        <div className="tharjrngnjfjfj">
          {this.state.followingId !== null ? (
            this.state.followingId !== "no" ? (
              this.state.followingId?.map((item, index) => {
                return (
                  <motion.div
                    layout
                    initial={{ opacity: 0 }}
                  ...
                  >
                    {this.state.followingId.length === index + 1 ? (
                      <InView
                      ...
                      >
                        <div className="jkrikskfjjr">
                          <div className="iconnf">
                            <IconProfile user={item.followingId} />
                          </div>
